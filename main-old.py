...
def analyze(players, displayLoadingBars=True):
    playerOBJs = []
    starttime = time.time()
    if displayLoadingBars : util.displayLoadingbar(0, 5, "Quering summoner info...")
    count = 0
    for player in players:
        ...
        count += 1
        if displayLoadingBars : util.displayLoadingbar(count, 5, "Quering summoner info...")
    
    if displayLoadingBars : util.displayLoadingbar(0, 5, "Quering mastery info...")
    count = 0
    for player in playerOBJs:
        ...
        count += 1
        if displayLoadingBars : util.displayLoadingbar(count, 5, "Quering mastery info...")
    
    count = 0
    if displayLoadingBars : util.displayLoadingbar(0, 20, "Quering matchlists...")
    for player in playerOBJs:
        matchlist = {}
        matchlist["matches"] = []
        for i in range(0, 4):
            ...
            count += 1
            if displayLoadingBars : util.displayLoadingbar(count, 20, "Quering matchlists...")
        player.setMatchlist(matchlist)
    
    count = 0
    if displayLoadingBars : util.displayLoadingbar(0, 5, "Quering league info...")
    for player in playerOBJs:
        ...
        count += 1
        if displayLoadingBars : util.displayLoadingbar(count, 5, "Quering league info...")
    ...
    count = 0
    if displayLoadingBars : util.displayLoadingbar(0, totalMatchCount, "Quering matches...")
    for i in range(0, maxMatchCount):
        for player in playerOBJs:
            ...
            count += 1
            if displayLoadingBars : util.displayLoadingbar(count, totalMatchCount, "Quering matches...")
